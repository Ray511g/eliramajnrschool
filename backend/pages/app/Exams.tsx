        ...
        <div className="page-container">
            ...
            <div className="search-filter-bar">
                <div className="form-group" style={{ marginBottom: 0, minWidth: 180 }}>
                    ...
                    <select className="filter-select" value={gradeFilter} onChange={e => setGradeFilter(e.target.value)} style={{ width: '100%' }}>
                ...
                <div className="form-group" style={{ marginBottom: 0, minWidth: 180 }}>
                    <label>Term</label>
                    <select className="filter-select" value={termFilter} onChange={e => setTermFilter(e.target.value)} style={{ width: '100%' }}>
