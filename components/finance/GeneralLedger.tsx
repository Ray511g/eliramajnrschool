...
const GeneralLedger: React.FC = () => {
    ...
    const filteredEntries = useMemo(() => (journalEntries || []).filter(e =>
    ...
    return (
        <div className="general-ledger animate-in">
                                    ...
                                    <td className="text-right">
                                        <div className="action-buttons-flex" style={{ justifyContent: 'flex-end' }}>
                                            ...
                                            {entry.status === 'Approved' && (
                                                <button className="action-btn delete" onClick={() => { if (window.confirm('Reverse this transaction? This will create an offsetting entry.')) reverseJournalEntry(entry.id); }} title="Reverse Entry" aria-label="Reverse posting">
            ...
            <AddJournalEntryModal isOpen={showForm} onClose={() => setShowForm(false)} />
        </div>
    );
};
